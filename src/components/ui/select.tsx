...
>(({ className, children, position = "popper", ...props }, ref) => (
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        "relative z-[200] max-h-80 min-w-[8rem] overflow-hidden rounded-lg border border-border bg-white text-foreground shadow-xl",
...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Item
    ...
    className={cn(
      ...
      "hover:bg-primary/8 focus:bg-primary/10 focus:text-primary",
